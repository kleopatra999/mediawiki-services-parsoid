...
Infobox.prototype.handleInfobox = function(manager, pipelineOpts, token, cb) {
	...
	//TODO: it's temporary fix for ticket DAT-3211. It can be a symptom of bigger problem.
	//fix doesn't cause corrupting the user's infobox data.
	for (arg in args) {
		args[arg] = args[arg] ? args[arg].wt : '';
	}
